...
//            ValidationDrawerBuilder.getInstance().setUser(new User(new ImageIcon(getClass().getResource("/raven/modal/demo/images/profile_1.jpg")), "Raven", "majid.hussainqutriyo@gmail.com", "admin"));
//        });
